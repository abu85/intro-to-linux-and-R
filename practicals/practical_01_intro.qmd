...
- Learn basic Linux shell commands and practice
- Load and explore data in R and set working directories
...
::: {.callout-tip title="Exercise" collapse="true"}
...
- print *content* of the sub-folder if it is there
