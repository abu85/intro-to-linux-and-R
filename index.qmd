...
*Unix/Linux:*
1. Describe Linux, CLI, Shell (pre-course materials, 1st meeting).
...
1. Describe R RStudio, data structure, set working directories(pre-course, 1st meeting).
...
## 🧰 `Before Day 1`
Read the `pre-course` ⬆️ and install `R`, `RStudio Desktop`, `Linux/Ubuntu` (windows users only), and be prepared accordingly. 

We will need following `tools` in the day 1:

::: {.callout-important collapse=true}
## 👉Tools needed at day1
